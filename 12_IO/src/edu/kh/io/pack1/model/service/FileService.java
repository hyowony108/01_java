...
public class FileService {
	...
	public void method1() {
		...
		// 리눅스, mac에서는 Usets/ , 윈도우에서는 C:/, D:/ 등
		
		// C:/io_test/20250305 폴더 생성
	...
	public void method2() {
		...
		if(!file.exists()) { // 존재하지 않으면
			...
			try {
				...
				// -> IOExceptiondml은 반드시 예외처리를 해야하는 checked Excption
				// -> 예외처리 필수
				...
				e.printStackTrace(); 
				// 예외에 대한 정보 + 예외가 발생한 위치까지의 메서드 추적
	...
	public void method3() {
		...
		for(File f : files) {
			...
			// String Simple DateFormat.format(long) : 
