...
public class SetService {
	...
	public void method2() {
		...
		// - 컬렉션 객체에 저장된 요소를
		//	 하나씩 순차 접근하는 객체
		System.out.println("[Iterator로 반복]");
	 ...
	 * 
	 * 금액을 입력받아 (천원 단위)
	 * 1000원 당 1회 씩 번호를 생성해서 List에 저장한 수
	 * 생성 종료 시 한 번에 출력
	 * 
	 * <pre>
	 * 금액 입력 : 3000
	 * 
	 * 1회 : [11, 20, 34, 34, 42, 43]
	 * 2회 : [1, 12, 22, 33, 35, 44]
	 * 3회 : [5, 6, 24, 43, 44, 45]
	 * </pre>
	 */
	public void lotthNumberGenerator() {
		...
		// 생성된 로또 번호 묶음(TreeSet)을 저장할 List객체 생성
