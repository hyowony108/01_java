...
public class ExceptionService {
	...
	public void ex1() {
		...
		if(input2 != 0) {
			...
			// input2에 0이 들어왓을때 0으로 나눌 수 없다 : 산술적 예외 발생
		...
		try {
			...
			// try 에서 던져진 예외를 catch문의 매개변수 e롷 잡음.
	...
	public void ex5() throws UserException{
		// 사용자 정의 예외인 UerException 사용하여 강제 예외 발생시키기
