...
public class BranchExample {
	...
	while(true ) {
		System.out.println("문자열 입력(ecit@ 입력 시 종료) : ");
		...
		// 비교연산자(==)는 보통 기본자료형 끼리의 연산에서만 사용 가능
		// String은 기본자료형이 아닌 참조형!
		
		//equals() 메서드
		// 문자열1.equals(문자열2)
		//-> 문자열1과 문자열 2가 같으면 true / 다르면  false 반환
