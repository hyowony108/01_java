...
public class User {
	...
	// 데이터 직접 적근 불가원칙 -> 필드는 기본적으로 모두 private (캡슐화 진행)
	...
	// 매개변수 자동완성 단축키 : alt + shift + s > Generate Constructor using Fields > generate
	...
	// toString() 메서드 : Object 최상위 클래스 이미 만들어져잇는 메서드
	// 객체가 문자열로 변환될 떄 호출되는 메섣
